                        ...
                        if (!regexp.test(email)) {
                            ...
                            jQuery.post(HOTCOFFEE_STORAGE['ajax_url'], {
                                ...
                                try {
                                    ...
                                    rez = {
                                        error: HOTCOFFEE_STORAGE['ajax_error']
                                    };
    ...
    if (sc_googlemap.length > 0) {
        sc_googlemap
            .each(function() {
                ...
                hotcoffee_googlemap_init(jQuery('#' + map_id).get(0), {
                    style: map_style,
                    zoom: map_zoom,
                    markers: map_markers
                });
...
function hotcoffee_sc_init_scroll_area(obj) {
    ...
    if (!hotcoffee_check_images_complete(obj) && HOTCOFFEE_STORAGE['scroll_init_counter']++ < 30) {
        setTimeout(function() {
            hotcoffee_sc_init_scroll_area(obj);
        }, 200);
        return;
    }
        ...
        var o = {
            ...
            diagram: function() {
                ...
                r.circle(c, c, Math.round(w / 2)).attr({
                    stroke: 'none',
                    fill: HOTCOFFEE_STORAGE['theme_skin_bg_color'] ? HOTCOFFEE_STORAGE['theme_skin_bg_color'] : '#ffffff'
                });
    ...
    if (!form_custom) {
        error = hotcoffee_form_validate(form, {
            ...
            rules: [{
                    ...
                    min_length: {
                        value: 1,
                        message: HOTCOFFEE_STORAGE['strings']['name_empty']
                    },
                    max_length: {
                        value: 60,
                        message: HOTCOFFEE_STORAGE['strings']['name_long']
                    }
                },
                {
                    field: "email",
                    min_length: {
                        value: 7,
                        message: HOTCOFFEE_STORAGE['strings']['email_empty']
                    },
                    max_length: {
                        value: 60,
                        message: HOTCOFFEE_STORAGE['strings']['email_long']
                    },
                    mask: {
                        value: HOTCOFFEE_STORAGE['email_mask'],
                        message: HOTCOFFEE_STORAGE['strings']['email_not_valid']
                    }
                },
                {
                    field: "subject",
                    min_length: {
                        value: 1,
                        message: HOTCOFFEE_STORAGE['strings']['subject_empty']
                    },
                    max_length: {
                        value: 100,
                        message: HOTCOFFEE_STORAGE['strings']['subject_long']
                    }
                },
                {
                    field: "message",
                    min_length: {
                        value: 1,
                        message: HOTCOFFEE_STORAGE['strings']['text_empty']
                    },
                    max_length: {
                        value: HOTCOFFEE_STORAGE['contacts_maxlength'],
                        message: HOTCOFFEE_STORAGE['strings']['text_long']
                    }
                }
            ]
        });
