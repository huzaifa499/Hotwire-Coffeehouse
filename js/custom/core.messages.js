...
function hotcoffee_message(opt) {
    ...
    jQuery('body .hotcoffee_message').animate({
        top: top + Math.round((jQuery(window).height() - jQuery('.hotcoffee_message').height()) / 2),
        opacity: 1
    }, {
        complete: function() {
            // Call init function
...
function hotcoffee_message_destroy() {
    ...
    jQuery('.hotcoffee_message').animate({
        top: top - jQuery('.hotcoffee_message').height(),
        opacity: 0
    });
    setTimeout(function() {
        hotcoffee_modal_bg.remove();
