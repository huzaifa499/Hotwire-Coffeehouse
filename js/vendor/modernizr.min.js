        ...
        return f.addTest = function(e, t) {
            ...
            function(e, t) {
                ...
                function i(e, n, r) {
                    ...
                    r || (r = o(n));
                    var i;
                    return !(i = r.cache[e] ? r.cache[e].cloneNode() : d.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e)).canHaveChildren || f.test(e) || i.tagUrn ? i : r.frag.appendChild(i)
                }
                ...
                function c(e) {
                    e || (e = t);
                    var r = o(e);
                    return v.shivCSS && !s && !r.hasCSS && (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), u || a(e, r), e
                }
                var l = {};
                e && (l = e.html5);
                var s, u, f = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,
